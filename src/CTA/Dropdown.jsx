...
const Dropdown = ({
  ...
  return (
    <>
      <h2 className="fs-4 fw-medium text-black shareLoginV2Question position-relative ps-4 mt-3">
        {label}{" "}
        {is_mandatory === "1" ? <span className="text-danger">*</span> : null}
      </h2>
      <div className="w-100 float-start shareLoginV2FormAnswr mt-4 ps-0">
